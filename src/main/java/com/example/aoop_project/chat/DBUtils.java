...
public class DBUtils {
    ...
    public static void createGroup(String groupName, int creatorId, List<Integer> memberIds) {
        String sqlGroup = "INSERT INTO groups (name, created_by) VALUES (?, ?)";
        ...
        try (Connection conn = getConnection();
            ...
            stmtGroup.setInt(2, creatorId);
            stmtGroup.executeUpdate();

            ResultSet keys = stmtGroup.getGeneratedKeys();
            if (keys.next()) {
