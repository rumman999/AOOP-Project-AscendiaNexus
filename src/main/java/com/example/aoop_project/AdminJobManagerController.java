...
public class AdminJobManagerController {
    ...
    private void handleDelete() {
        ...
        // Make this dialog modal to the Job Manager window
        Stage owner = (Stage) tblJobs.getScene().getWindow();
        ...
        confirmation.showAndWait().ifPresent(response -> {
            if (response == ButtonType.OK) {
                try {
                    ...
                    String userTypeRefresh = Session.getLoggedInUserType();
                    if ("Admin".equals(userTypeRefresh)) {
                        loadAllJobs();
                    } else {
                        loadRecruiterJobs();
                    }
    ...
    private void showAlert(String msg) {
        ...
        // Make alert modal to the Job Manager window
        if (tblJobs != null && tblJobs.getScene() != null) {
            Stage owner = (Stage) tblJobs.getScene().getWindow();
